...
export const CustomSheet = SheetPrimitive.Root
export const CustomSheetTrigger = SheetPrimitive.Trigger
export const CustomSheetClose = SheetPrimitive.Close
export const CustomSheetPortal = SheetPrimitive.Portal

export const CustomSheetOverlay = React.forwardRef<
...
export const CustomSheetContent = React.forwardRef<
